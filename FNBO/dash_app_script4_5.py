...
html.Div(style={'margin': '20px 0px'}, children=[
    ...
    dcc.RadioItems(
        ...
        value='precision',  # Default sorting is by Precision
        inline=True
    )
]),
...
def update_rules(n_clicks, outcome_column, feature_columns, sort_by):
    if n_clicks == 0:
        return []
    ...
    for rule_string, (precision, recall, _) in sorted_rules:
        ...
        # Create a formatted string for each rule with its precision and recall percentages
